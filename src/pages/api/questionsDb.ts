...
const questions: QuestionModel[] = [
  new QuestionModel(306, 'Quais dos seguintes materiais podem ser reciclados?', [
  ...
  new QuestionModel(
    202,
    'Sobre as hidrelétricas é incorreto afirmar:',
    [
      OptionModel.isWrong('As hidrelétricas causam grande impacto ambiental e social'),
      OptionModel.isWrong('Causa extinção de certas espécies de peixes'),
      OptionModel.isWrong('Os reservatórios de hidrelétricas ajudam a absorver os gases do efeito estufa'),
      OptionModel.isCorrect('Florestas inundadas se decompõe produzindo sulfeto de hidrogênio (H2S)'),
    ]
  ),
/*
...
*/
  ...
  new QuestionModel(205, 'O que são as águas cinzas?', [
    OptionModel.isWrong('Águas provenientes da cozinha, devido à alta concentração de matéria orgânica'),
    OptionModel.isWrong('Águas que podem ser reaproveitadas de forma potável'),
    OptionModel.isWrong('Água residual industrial que pode ser reaproveitada para usos não potáveis'),
    OptionModel.isCorrect('Água residual originada de processos domésticos como lavar louça'),
  ]),
/*
...
*/
  ...
  new QuestionModel(211, 'Qual a porcentagem de água do planeta que é doce e pode ser usada para consumo humano?', [
  ...
  new QuestionModel(
    ...
    [
      ...
      OptionModel.isWrong('Pode ser aproveitada por meio de painéis fotovoltaicos e usinas heliotérmicas'),
      OptionModel.isWrong('Preço elevado em relação às demais fontes de energia'),
      OptionModel.isCorrect('É necessária a instalação de baterias para armazenar a energia gerada'),
    ]
  ),

  new QuestionModel(213, 'Qual é o melhor período do dia para regar o gramado?', [
  ...
  new QuestionModel(214, 'A Madeira é um material reciclável?', [
    ...
    OptionModel.isWrong('Sim, e deve ser descartado no ecoponto azul (papel e cartão)'),
    OptionModel.isWrong('Não e deve ser descartado de maneira diferente'),
    OptionModel.isCorrect('Sim, e deve ser descartado no ecoponto amarelo (plástico e metal)'),
  ]),
  ...
  new QuestionModel(216, 'Qual dos seguintes cuidados a se ter ao descartar material reciclável é falso?', [
    ...
    OptionModel.isCorrect('Lavar as embalagens de plástico, vidro e alumínio'),
  ]),
];
